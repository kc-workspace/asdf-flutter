...
KC_ASDF_NAME="asdf-flutter"
KC_ASDF_REPO="https://github.com/kc-workspace/asdf-flutter"
export KC_ASDF_ORG KC_ASDF_NAME KC_ASDF_REPO

## Application information
KC_ASDF_APP_TYPE="standalone"
KC_ASDF_APP_NAME="flutter"
KC_ASDF_APP_WEBS="https://flutter.dev"
KC_ASDF_APP_DESC="easy and fast to build beautiful apps for mobile and beyond"
KC_ASDF_APP_CMDS="
- test    - test if cli exist and executable
- version - print *plugin* version
"
KC_ASDF_APP_REPO="https://github.com/flutter/flutter"
